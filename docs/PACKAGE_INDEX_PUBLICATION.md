...
| Python | [turkiye-iban-python](https://github.com/trugurpala/turkiye-iban-python) | [v0.1.1](https://github.com/trugurpala/turkiye-iban-python/releases/tag/v0.1.1) | PyPI `turkiye-iban` | Trusted Publisher not configured; index entry not verified |
