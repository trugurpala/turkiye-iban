...
| PHP ve Python runtime paketlerinin henuz olmamasi | Orta | Dil bagimsiz JSON, CSV, SQL ve SQLite ciktilari yayimlanir; istemciler ayri issue'lardadir | Bazi ekipler hazir Composer veya PyPI paketi bekleyebilir | Ayri istemci depolari planlanana kadar "her dilde paket hazir" denmez | PHP/Python issue'lari ele alindiginda |
