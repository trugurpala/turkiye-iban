...
| PHP ve Python runtime paketlerinin henuz olmamasi | Orta | Dil bagimsiz JSON, CSV, SQL ve SQLite ciktilari yayimlanir; PHP ve Python istemci tasarimlari ayri dokumanlarda tutulur | Bazi ekipler hazir Composer veya PyPI paketi bekleyebilir | Ayri istemci depolari acilip yayinlanana kadar "her dilde paket hazir" denmez | PHP/Python repository calismasi basladiginda |
